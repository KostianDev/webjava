...
public class ProductService {
    ...
    public void init() {
        // sample data
        Product p1 = new Product(UUID.randomUUID(), "Star Yarn", "Antigravity yarn for space knitting", new BigDecimal("9.99"), "Textiles");
        Product p2 = new Product(UUID.randomUUID(), "Galaxy Milk", "Enriched milk from the Andromeda herds", new BigDecimal("4.50"), "Food");
